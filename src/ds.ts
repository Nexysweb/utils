...
export const keepProps = (obj: any, props: any): any => {
  ...
  return Object.entries(obj).reduce(
    (acc, [key, value]) =>
      props.includes(key) ? { ...acc, [key]: value } : acc,
    {}
  );
};
 ...
 * @return updated form
 */
export const updateObject = (form: any, newObj: any): any =>
  set(newObj.name, newObj.value, form);
 ...
 * @return boolean
 */
export const hasProp = (o: any, prop: any): boolean =>
  !isEmpty(o) && prop && prop in o;
...
export const removePrefix = (obj: any, prefix: string): any => {
  ...
  return Object.keys(obj).reduce(
    (a, key) => ({ ...a, [key.replace(prefix, "")]: obj[key] }),
    {}
  );
};
 ...
 */
export const compareWithArray = (
  newRecord: any,
  oldRecords: any[],
  isRecordFound: (a: any, b: any) => boolean,
  isDuplicate: (a: any, b: any) => boolean = (x) => false,
  isNotNull: (a: any) => boolean = (x) => true
) => {
...
export const isJoi = (schema: any): boolean =>
  schema.hasOwnProperty("$_root") || schema.hasOwnProperty("$_super");
