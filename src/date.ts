 ...
 * @return new date
 */
export const addYears = (date: Date, n: number = 1) =>
  new Date(date.setFullYear(date.getFullYear() + n));
 ...
 * @return new date
 */
export const addMonths = (date: Date, n: number = 1): Date =>
 ...
 * @return new date
 */
export const addDays = (date: Date, n: number = 1): Date =>
  new Date(date.setDate(date.getDate() + n));

export const addMs = (date: Date, n: number = 1): Date =>
  new Date(date.setMilliseconds(n));
 ...
 */
export const findNumberOfDaysInMonth = (
  month: number,
 ...
 * @return ISO date
 */
export const dateToISO = (d: Date | string | undefined): string | undefined => {
